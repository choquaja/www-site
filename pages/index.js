      ...
      <Layout meta={meta} light>
                ...
                <div className="hero-translate">
                  <Browser>
                    <Console>
                      ...
                      <CodeInput>
                        $ tbs server serve MyNotebook --template tensorflow-gpu
                      </CodeInput>
                      <CodeOutput>Server created.</CodeOutput>
                      <CodeOutput>Server started.</CodeOutput>
                      <CodeOutput>
                        Endpoint: "http://go.3blades.io/server/228d193e-7212-41fe-a8b3-e31814301363/jupyter/tree"
                      </CodeOutput>
                    </Console>
                  </Browser>
                </div>
        ...
        <ContentSection dark-blue-gradient style={firstContentSectionStyles}>
                ...
                <div className="card">
                  <div className="card-wrapper">
                    ...
                    <div className="card-body">
                      ...
                      <Buttons
                        full-width
                        className="padding-top-gutter"
                        items={ShowcaseButton}
                      />
                    </div>
                  </div>
                </div>
          ...
          <ContentPane
            half
            center-vertically
            className="blue-section-right padding-sides-gutter"
          >
            <Title>
          ...
          <ContentPane
            ...
            align-end
            style={topLeftCard}
            className="cards-home-translate"
          >
            <Body>
