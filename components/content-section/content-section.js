...
export class Title extends React.Component {
    ...
    render() {
        return (
            <div className={"content-section-title title-l wiggle-after " + this.props.className}>
...
export class Subtitle extends React.Component {
    ...
    render() {
        return (
            <div className={"content-section-subtitle title-med " + this.props.className}>
...
export class Graphic extends React.Component {
    ...
    render() {
        ...
        if(this.props.label){
            ...
            if(this.props.link){
                label = label = () => (<div className="content-section-graphic-label"><a href={this.props.link}>{this.props.label}</a></div>);
