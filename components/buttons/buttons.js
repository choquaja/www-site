...
export default class Buttons extends React.Component {
    ...
    render() {
        ...
        if (this.props.items) {
            return (<div className={'buttons' + classes }><div className="buttons-wrapper">{renderButtons(this.props.items)}</div></div>);
        } else {
            return (<div className={'buttons' + classes }><div className="buttons-wrapper">{this.props.children}</div></div>);
        }
    }
}
